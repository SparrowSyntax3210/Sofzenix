      ...
      <div className="flex-1 p-8 bg-gray-100 text-black">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-2 text-lg max-w-3xl">
              Welcome back! Track your internship progress, attendance,
              assigned tasks, performance, and certificates from one dashboard.
            </p>
          </div>
          ...
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-4xl font-bold mb-3">
                Welcome to Sofzenix Internship Portal
              </h2>

              <p className="text-lg opacity-95 max-w-xl">
                View your daily tasks, attendance, performance reviews, offer
                letter, internship certificate, and stay updated throughout your
                internship.
              </p>
        ...
        <div className="mt-8 bg-white p-6 rounded-xl shadow-lg">
          ...
          <ul className="space-y-3 text-lg text-black">
            <li>✅ Completed Task: Login Integration</li>
            <li>📅 Attendance Marked</li>
            <li>📄 Offer Letter Uploaded</li>
            <li>🏆 Performance Review Updated</li>
          </ul>
        </div>
      </div>
    </div>
